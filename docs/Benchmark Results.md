...
Use the [0.9 release notes](releases/0.9.md#performance), [calibrated receipt in PR #82](https://github.com/bazer/DataLinq/pull/82), [#26 allocation disposition](https://github.com/bazer/DataLinq/issues/26#issuecomment-5344291969), and [#101 final SQL disposition](https://github.com/bazer/DataLinq/issues/101) for exact values, commits, run identity, and rationale. The final package-backed evidence and explicit release GO are recorded in [issue #80](https://github.com/bazer/DataLinq/issues/80).
