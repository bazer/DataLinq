...
| `--allocation-regression` | 9 | `sqlite-memory` | 9 | provider/startup `1`; CRUD small `250`; CRUD batch `350`; update `2000`; cold PK/relation `1000`; warm PK `60000`; warm relation `1000000` |
