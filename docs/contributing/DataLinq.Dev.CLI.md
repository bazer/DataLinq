...
dotnet run --project DataLinq.Dev.CLI -- api-report --baseline-dir artifacts/api-baseline/nuget-org-0.9.0 --candidate-dir artifacts/nuget-release/0.10.0-preview.N --candidate-version 0.10.0-preview.N
