...
- OAPI-4/OAPI-5/OAPI-6 policies are accepted under AAPI-21 through AAPI-41, and OAPI-7's main policies under AAPI-42 through AAPI-72. The smaller provider/helper I/O and complete signature/compatibility audit remains open under OAPI-7; synchronous-navigation guidance remains under OAPI-8 and Memory/neutral-source capability/provider limits under OAPI-9. Accepted signatures, fields/enums/constructors, custom compatibility, and internal coordination/versioning require consumer, deterministic runtime, and W0 cost evidence. Async-stream mutation inputs, bulk execution, and automatic mutation dependency ordering remain outside 0.10.
