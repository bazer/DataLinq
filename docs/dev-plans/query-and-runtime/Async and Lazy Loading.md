...
- OAPI-4/OAPI-5/OAPI-6 policies are accepted under AAPI-21 through AAPI-41, OAPI-7's main/helper/diagnostic policies and first audit findings under AAPI-42 through AAPI-72 and AAPI-82 through AAPI-102, and OAPI-8/OAPI-9 policies under AAPI-73 through AAPI-81. OAPI-7 remains open for E01–E06 exact declaration/integration expansions and the complete compatibility/evidence audit. Accepted contracts and internal coordination/versioning require consumer, deterministic runtime, provider, and W0 cost evidence. Further design questions must come from concrete gaps/contradictions, not reopening accepted policy. Async-stream mutation inputs, bulk execution, and automatic mutation dependency ordering remain outside 0.10.
