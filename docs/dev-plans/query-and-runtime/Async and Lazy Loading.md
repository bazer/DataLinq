...
- OAPI-4/OAPI-5/OAPI-6 policies are accepted under AAPI-21 through AAPI-41, and OAPI-7's query/key/relation policies under AAPI-42 through AAPI-55. Lower-level execution/ownership, metadata/attached resources, mutation/callback receivers, and context/configuration signatures still require OAPI-7 review; Memory/neutral-source capability and provider limits remain under OAPI-9. Accepted signatures/custom compatibility and internal coordination/versioning require consumer, deterministic runtime, and W0 cost evidence. Async-stream mutation inputs, bulk execution, and automatic mutation dependency ordering remain outside 0.10.
