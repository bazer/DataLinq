...
- Exact primitive/overload inventories and diagnostic types still require review. Enumeration timing, buffering/streaming, snapshot/token lifetime, failure, and concurrency details remain open in the decision record.
