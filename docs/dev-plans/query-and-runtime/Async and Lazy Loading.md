...
- OAPI-4/OAPI-5/OAPI-6 policies are accepted under AAPI-21 through AAPI-41, OAPI-7's main/helper/diagnostic policies and declaration findings under AAPI-42 through AAPI-72 and AAPI-82 through AAPI-105, and OAPI-8/OAPI-9 policies under AAPI-73 through AAPI-81. OAPI-7 remains open for E04–E06 validation/package/manifest work and the complete compatibility/evidence audit, including actual E01–E03 verification. Accepted contracts and internal coordination/versioning require consumer, deterministic runtime, provider, and W0 cost evidence. Further design questions must come from concrete gaps/contradictions, not reopening accepted policy. Async-stream mutation inputs, bulk execution, and automatic mutation dependency ordering remain outside 0.10.
