...
- [x] Update public shipped transaction/troubleshooting docs and XML API remarks for the tested attached/external policy without presenting the remaining lifecycle/provider gaps as shipped support.
