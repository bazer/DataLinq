...
**Status:** Mostly implemented across Roadmap Phase 2, Phase 8, Phase 8B, and Phase 8C. Remaining generator/runtime ideas now belong to newer focused plans such as scalar converters, generated provider-key cache cleanup, and the 0.8 query-plan work.
