...
The updated default expected/runtime package sets make extra override flags unnecessary. The final RC must preserve that default and record any deliberate override lists in the manifest so a report cannot silently omit Memory. The completed W10 tooling probe is the fresh `0.9.0-preview.w10.2` directory and default report at `artifacts/dev/package-report/20260804-075329094`; it is not the final RC or publication evidence.
