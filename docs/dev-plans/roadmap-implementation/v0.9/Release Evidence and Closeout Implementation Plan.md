...
**Status:** Accepted. The bounded W8 project-reference Memory constrained-runtime graph, SC-6A canonical-`Guid` equality island, D5-B local package promotion, aggregate M0, bounded M1-A exact non-null inequality, bounded M1-B exact Boolean composition, and W10 step-3 / RE-1A Testing CLI registration are implemented and green; the remaining M1/M2, RE-1, W10 compatibility/package work, and final release-candidate reruns remain open.
...
- captured scalar equality and inequality
- ordering plus `Take`
