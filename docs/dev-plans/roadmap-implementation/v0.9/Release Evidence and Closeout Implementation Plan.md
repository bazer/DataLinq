...
**Status:** Accepted. The bounded W8 project-reference Memory constrained-runtime graph, SC-6A canonical-`Guid` equality island, D5-B local package promotion, aggregate M0, and W10 step-3 / RE-1A Testing CLI registration are implemented and green; the remaining RE-1 and W10 compatibility/package work and final release-candidate reruns remain open.
