...
**Status:** Accepted. Aggregate M0, bounded M1-A exact non-null inequality, and bounded M1-B exact Boolean composition are complete; aggregate M1-M3 remain open.
