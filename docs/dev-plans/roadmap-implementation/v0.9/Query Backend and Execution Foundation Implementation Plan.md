...
The final relation-caller sentence in the preceding cumulative inventory now has one bounded exception: the exact `Int32`-backed converted PK/FK lazy relation shape documented under F6 composes through dynamic canonical keys. Joined callers and every relation shape beyond that exact integral-converter checkpoint remain uncharacterized.
