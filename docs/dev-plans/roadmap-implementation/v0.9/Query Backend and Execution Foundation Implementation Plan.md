...
The converter-backed admission above is specifically canonical `Int32`. Other converted integral provider types remain on the legacy relation path until their own end-to-end evidence lands; non-converted integral F6-B behavior is unchanged.
