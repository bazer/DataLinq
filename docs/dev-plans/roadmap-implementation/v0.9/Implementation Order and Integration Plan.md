...
The bounded W8 step-10 graph satisfies the constrained-runtime execution and dependency-isolation part of this gate for the current 31-token profile. D5 remains open until the public construction and seed surface plus package dependencies have been reviewed; project-reference evidence is not package-promotion evidence.
