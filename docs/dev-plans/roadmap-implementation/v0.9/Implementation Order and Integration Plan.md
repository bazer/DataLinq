...
- [ ] Complete SC-3 for converted joined-reader keys beyond exact scalar `Int32` and `Int64`, composite reader keys, and external relation/index lookup normalization without losing operand provenance.
