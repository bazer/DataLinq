...
2. **Bounded M0-A complete:** seed validation, isolated stores, generated startup, and public exact single-column primary-key lookup are proven; aggregate `M0` remains open for Testing CLI registration and the raw-SQL-rejection boundary.
