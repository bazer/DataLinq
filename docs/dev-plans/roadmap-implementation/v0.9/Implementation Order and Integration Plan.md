...
- [ ] Complete the remaining `TX-4` provider-call outcome-unknown partition without claiming that low-level `DatabaseAccess` or underlying `IDbTransaction` handles are gated.
