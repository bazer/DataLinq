...
| W6-W7 | Scalar documentation/schema tests and UUID codec work | Follow the UUID plan's granular prerequisites; bounded `UUID-4` format validation consumes the first SC-5 handoff, while canonical/source-only/default completion remains gated |
