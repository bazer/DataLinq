...
**Status:** The scoped 0.9 feature implementation is complete. Memory M0-M2 closes at the explicit 58-token experimental preview boundary, and the already-implemented bounded W3-W6/UUID slices define the 0.9 core contract. Their unbounded remainder is deferred rather than treated as a release blocker. Continue with a fresh release candidate, the practical validation checklist, release notes, and publication.

**W5/F4-B/F5 progress:** The live contract contains 617 contextual features and 359 supported versus 258 unsupported SQL dispositions. The new direct-model-value projection shape describes existing SQL projection behavior and the widened Memory preview surface; the exhaustive SQL matrix fingerprint is `ECBA5493979A4E8CC3FEC4CB8B0B3972DF369074C03ACBB70F7B5F26613CF9E7`. Historical checkpoint counts below remain historical.
