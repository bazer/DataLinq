...
- [ ] Complete attached external-completion handling for managed read, write, and disposal, publish the ownership contract, and define full concurrency semantics.
