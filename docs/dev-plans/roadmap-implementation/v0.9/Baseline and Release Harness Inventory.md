...
**Status:** W0-W2 complete. This remains the 2026-07-10 before-state; later bounded implementation checkpoints, including the W8 step-10 provider-free memory constrained-runtime graph and SC-6A canonical-`Guid` equality island, are recorded separately below and do not rewrite the baseline.
...
| D5 memory project/package boundary | Separate non-packable graph and D5-A public construction/seed/query surface proven; independent surface review is green, while actual package dependency/assets evidence still gates promotion | W8/W9 |
