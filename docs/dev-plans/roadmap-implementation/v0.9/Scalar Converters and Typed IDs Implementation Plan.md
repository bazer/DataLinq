...
- schema validation tests proving physical SQL type and UUID-format checks remain distinct; independent canonical compatibility remains an open SC-5 gate
