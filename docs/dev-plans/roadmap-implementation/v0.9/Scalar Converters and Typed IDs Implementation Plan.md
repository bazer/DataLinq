...
- schema validation tests proving physical SQL type, bounded finalized converter-backed canonical `Int32` compatibility, and UUID-format checks remain distinct; other canonical CLR types and authoritative source-only converter resolution remain open SC-5 gates
