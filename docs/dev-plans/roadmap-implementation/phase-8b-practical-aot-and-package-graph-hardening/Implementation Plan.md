...
2. [in progress] Represent source-model metadata, generated declarations, SQLite metadata, MySQL metadata, and MariaDB metadata in builder form. SQLite metadata now builds a typed provider-local draft before factory finalization; source-model, generated runtime, MySQL, and MariaDB paths still hand mutable metadata graphs through the draft boundary.
