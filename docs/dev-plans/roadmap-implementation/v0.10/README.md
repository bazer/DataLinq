...
W0-F1 follow-up, 2026-09-17: the [SQLite pool ownership investigation](SQLite%20Pool%20Ownership%20Investigation.md) reproduces the driver race and records a locally tested upstream correction. DataLinq's dependency is unchanged; the blocker remains open pending upstream integration and verified package adoption.
