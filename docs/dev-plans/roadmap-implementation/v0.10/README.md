...
W1.1's [internal command/reader contracts](W1%20Internal%20Execution%20Contracts.md) and W1.2's [transaction ownership and initialization foundation](W1%20Transaction%20Ownership%20and%20Initialization.md) are merged. The next [owned read integration](W1%20Owned%20Read%20Execution.md) replaces thread-based hydration permission with explicit private authority and adds bounded synchronous source/reader admission. Native provider initialization and public APIs remain unchanged; whole query/relation invocation ownership, async reader orchestration, recovery and invocation capture remain open.
