...
W1.1's [internal command/reader contracts](W1%20Internal%20Execution%20Contracts.md), W1.2's [ownership/initialization](W1%20Transaction%20Ownership%20and%20Initialization.md), [owned reads](W1%20Owned%20Read%20Execution.md), [synchronous query/relation ownership](W1%20Query%20and%20Relation%20Ownership.md) and [async reader enumeration](W1%20Async%20Reader%20Enumeration.md) are merged. The next [read failure/recovery slice](W1%20Read%20Failure%20and%20Recovery.md) requires explicit integrity evidence before reuse and records immutable ordered failures. Automatic recovery budgets, native wiring, full invocation capture, helper draining, public diagnostics and coordination cost acceptance remain open.
