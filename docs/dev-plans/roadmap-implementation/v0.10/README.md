...
W1.1's [internal command/reader contracts](W1%20Internal%20Execution%20Contracts.md) are merged. The next [transaction ownership and initialization foundation](W1%20Transaction%20Ownership%20and%20Initialization.md) shares explicit leases with the existing synchronous mutation/completion guard and tests lazy resource publication. Native provider initialization and public APIs remain unchanged; private hydration/source admission, reader orchestration, recovery and invocation capture remain open.
