...
W1.1's [internal command/reader contracts](W1%20Internal%20Execution%20Contracts.md), W1.2's [transaction ownership and initialization foundation](W1%20Transaction%20Ownership%20and%20Initialization.md) and the [owned read integration](W1%20Owned%20Read%20Execution.md) are merged. The next [query and relation ownership integration](W1%20Query%20and%20Relation%20Ownership.md) retains synchronous admission through outer enumeration, including buffered results, and rejects overlapping enumerator calls. Native provider initialization and public APIs remain unchanged; async reader orchestration, recovery, full invocation capture and coordination cost acceptance remain open.
