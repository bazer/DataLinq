...
W1.1's [internal command/reader contracts](W1%20Internal%20Execution%20Contracts.md), W1.2's [transaction ownership and initialization foundation](W1%20Transaction%20Ownership%20and%20Initialization.md), [owned reads](W1%20Owned%20Read%20Execution.md) and [synchronous query/relation ownership](W1%20Query%20and%20Relation%20Ownership.md) are merged. The next [async reader enumeration slice](W1%20Async%20Reader%20Enumeration.md) adds internal deferred acquisition, combined tokens, overlap rejection and awaited cleanup with controllable-provider evidence. Native provider wiring and public APIs remain unchanged; failure/recovery orchestration, full invocation capture, helper draining and coordination cost acceptance remain open.
