...
| W2.3 Captured query/key/relation/fluent integration, actual row conversion, complete/invalidation-safe cache publication and early reader cleanup | Native conversion, binary/composite keys, capture and cache-generation checks below; final parity pending | Native conversion, binary/composite keys, capture and cache-generation checks below; final parity pending | Native conversion, binary/composite keys, capture and cache-generation checks below; final and corrected-package acceptance pending |
| W2.4 Tracked mutations/private hydration, commit/rollback certainty, independent recovery budget, disposal and mixed execution | Native values, finite batches, completion loss, cooperative recovery and cleanup failure verified below; final reconciliation pending | Native values, finite batches, completion loss, cooperative recovery and cleanup failure verified below; final reconciliation pending | Native commit rejection and cleanup-error preservation verified below; failed-rollback file-pool reuse and final acceptance remain open |
...
| W2.6 Native interruption, soft/hard cancellation, timeout/connection trust and no-dispatch/cleanup classification; final parity and performance review | Native read/write soft/hard interruption, completion loss, recovery budget and cleanup evidence below; final matrix and acceptance pending | Native read/write soft/hard interruption, completion loss, recovery budget and cleanup evidence below; final matrix and acceptance pending | Between-row cancellation, blocking limits and native cleanup classification verified; failed-rollback pool integrity, official fix adoption and final acceptance pending |
