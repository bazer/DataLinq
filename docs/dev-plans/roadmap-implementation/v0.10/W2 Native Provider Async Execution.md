...
| W2.5 Metadata parsers, existence/availability, per-command timeout, provisioning, journal mode, keeper and owning-root lifetimes | Probes, provisioning and owning-root disposal bound; metadata pending | Probes, provisioning and owning-root disposal bound; metadata pending | Pending |
