...
| W2.4 Tracked mutations/private hydration, commit/rollback certainty, independent recovery budget, disposal and mixed execution | Basic binding plus interrupted writes, completion failure and independent recovery checks; generated values and full failure matrix pending | Basic binding plus interrupted writes, completion failure and independent recovery checks; generated values and full failure matrix pending | Pending |
