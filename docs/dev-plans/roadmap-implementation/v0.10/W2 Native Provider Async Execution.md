...
| W2.6 Native interruption, soft/hard cancellation, timeout/connection trust and no-dispatch/cleanup classification; final parity and performance review | Native read/write soft/hard interruption, completion loss, recovery budget and cleanup evidence below; final matrix and acceptance pending | Native read/write soft/hard interruption, completion loss, recovery budget and cleanup evidence below; final matrix and acceptance pending | Between-row cancellation and blocking limits verified; native cleanup faults, official fix adoption and final acceptance pending |
