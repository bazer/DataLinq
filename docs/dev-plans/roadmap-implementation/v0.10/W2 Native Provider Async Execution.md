...
| W2.4 Tracked mutations/private hydration, commit/rollback certainty, independent recovery budget, disposal and mixed execution | Generated values and finite-batch interruption verified alongside earlier mutation/recovery checks; full failure matrix pending | Generated values and finite-batch interruption verified alongside earlier mutation/recovery checks; full failure matrix pending | Generated values and finite-batch interruption verified alongside earlier hydration/cache checks; full failure matrix pending |
