...
**Integration status (2026-09-23):** [W1 Closeout](W1%20Closeout.md) reconciles the complete internal requirement/I/O inventory, verifies 5,226 local cases in both Debug and Release and all 90 canonical benchmark rows, and records the retained performance trade-offs. [PR #227](https://github.com/bazer/DataLinq/pull/227) is the required exact-head CI and guarded integration receipt. After that verified merge, no internal W1 deliverable remains; native W2, public/packed W3 and the limited W0-F1 exception stay separate. The following paragraphs preserve earlier slice history, not new outstanding W1 work.
