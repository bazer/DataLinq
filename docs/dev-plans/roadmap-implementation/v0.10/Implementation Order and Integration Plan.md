...
The [telemetry allocation reduction](W1%20Telemetry%20Allocation%20Reduction.md) adds two late-listener controls and passes 5,201 broad local cases. Its clean before/candidate nine-row benchmarks reduce warm-key allocation overhead from +15.1% to +2.9%, with unchanged workload telemetry, but five allocation warnings remain. This is a measured reduction, not F19/F21 closure; internal coordination measurements and all six final strict lanes remain open.
