...
- enforce AAPI-49/AAPI-50: existing database/transaction/generated key helper families and source overloads, typed model-to-provider normalization exactly once, capture before suspension, nullable missing-key results, and null-key sentinel parity; Memory/neutral-source capability remains under OAPI-9
...
OAPI-7's query/key/relation policies are accepted under AAPI-42 through AAPI-55; complete their signature/consumer, generated-diagnostic, and compatibility evidence. Public accessors/options, callback/mutation receiver inventory, lower-level execution/ownership, and metadata/attached-resource boundaries remain open under OAPI-7. Provider-specific interruption/classification, Memory capability, and recovery-budget feasibility remain under OAPI-9 and W1/W2. AAPI-34 through AAPI-41 settle wider operation/shared-load coordination, private ownership across awaits, and recovery of unfinished callback work. Private gate/versioning representations and cost remain implementation choices; preserve AAPI-28's exclusive mutable lifetime and AAPI-32's borrowed completion restrictions.
