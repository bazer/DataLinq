...
**Follow-through, 2026-09-20:** [Async query telemetry](W1%20Async%20Query%20Telemetry.md) implements that bounded logical-query integration and records 39 focused cases plus broad verification. Its added async coordination cost remains unmeasured; this earlier performance checkpoint does not qualify the later runtime or close command/transaction telemetry.
