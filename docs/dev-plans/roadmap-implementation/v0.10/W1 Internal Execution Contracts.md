...
The [ownership and initialization record](W1%20Transaction%20Ownership%20and%20Initialization.md) describes explicit leases shared with the existing synchronous mutation/completion guard, protected internal steps and reader handoff, and a lazy resource state machine verified with controllable initializers. The subsequent [owned reads](W1%20Owned%20Read%20Execution.md) and [query/relation ownership](W1%20Query%20and%20Relation%20Ownership.md) extend synchronous admission through hydration and outer enumeration. The [async reader enumeration slice](W1%20Async%20Reader%20Enumeration.md) adds deferred single-reader orchestration, combined tokens and awaited cleanup with controllable providers. Native wiring/initialization, full invocation capture and helper recovery remain pending; these slices do not claim full W1.2 or W1 completion.

## Remaining W1 Slices

The [W1 completion audit](W1%20Completion%20Audit.md) is the current requirement-by-requirement evidence checklist. [Helper lifetime and draining](W1%20Helper%20Lifetime%20and%20Draining.md) follows merged automatic recovery #155; it adds internal callback/reader draining without claiming all operation families or native/public helper wiring are complete. The [eager read follow-through](W1%20Eager%20Read%20Failure%20Reporting.md) covers pending eager failures and independent owned cleanup; the subsequent [managed completion slice](W1%20Managed%20Async%20Completion.md) connects real cache/mutable finalization and helper recovery. Initialization handoff, mutation and full telemetry integration remain open.

| Next slice | Required work and evidence |
| --- | --- |
| W1.2 ownership follow-through | Synchronous outer enumeration and the internal [async single-reader lifetime](W1%20Async%20Reader%20Enumeration.md) retain shared admission. Native wiring, async private hydration, complete initialization/helper handoff and coordination cost measurement remain open; no lock held across arbitrary awaits |
| W1.3 cancellation, completion and recovery | [Read failure/recovery integration](W1%20Read%20Failure%20and%20Recovery.md) adds evidence-based restrictions and immutable ordered diagnostics. [Automatic recovery rollback](W1%20Automatic%20Recovery%20Rollback.md) adds a captured independent budget and owned one-attempt cleanup boundary. Complete initialization handoff, native classification/confirmation, provider/host settings, async mutation finalization and complete diagnostic integration remain open; no implicit retries or abandoned operations |
| W1.4 invocation/source capture and handoff | Internal single-reader exits and combined tokens are covered; owned generated commands, full ordinary/prepared/mutation snapshots, relation/cache publication races and mapping every I/O family remain open |
