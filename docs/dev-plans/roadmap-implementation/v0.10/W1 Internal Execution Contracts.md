...
| W1.3 cancellation, completion and recovery | [Read failure/recovery integration](W1%20Read%20Failure%20and%20Recovery.md) adds evidence-based restrictions, ordered failures and immutable completion/recovery snapshots. Independent automatic rollback budgets, native classification/confirmation, async mutation finalization and complete diagnostic integration remain open; no implicit retries or abandoned operations |
