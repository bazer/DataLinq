...
| W1.3 cancellation, completion and recovery | [Read failure/recovery integration](W1%20Read%20Failure%20and%20Recovery.md) adds evidence-based restrictions and immutable ordered diagnostics. [Automatic recovery rollback](W1%20Automatic%20Recovery%20Rollback.md) adds a captured independent budget and owned one-attempt cleanup boundary. Helper admission/draining, native classification/confirmation, provider/host settings, async mutation finalization and complete diagnostic integration remain open; no implicit retries or abandoned operations |
