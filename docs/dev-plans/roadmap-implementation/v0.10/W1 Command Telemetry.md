> [!WARNING]
> W1 provider-boundary reporting and controllable async evidence only. Native async adoption, synchronous logical-query/mutation/transaction observer composition and W1 closeout remain open.
