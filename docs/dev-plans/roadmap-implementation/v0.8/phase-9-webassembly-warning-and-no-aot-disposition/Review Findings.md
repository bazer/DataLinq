...
**Reviewed scope:** WebAssembly warning classification, no-AOT/browser reporting behavior, current compatibility artifacts, and phase 9 docs in the `v0.8` branch through `a978d85a`.
