...
| Phase 15: Relation-Aware and Implicit Joins | In progress for implicit singular relation predicates/orderings | `phase-15-relation-aware-and-implicit-joins/` | Add the first SQL-backed implicit singular relation traversal slice and document the deferred fluent/left-join APIs. |
