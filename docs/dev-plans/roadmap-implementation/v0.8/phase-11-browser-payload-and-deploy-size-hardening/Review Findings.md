...
**Reviewed scope:** release-threshold code, payload inspector, size-report CLI docs, compatibility reporting docs, and phase 11 docs in the `v0.8` branch through `57da59e2`.
