...
The current design direction for DataLinq's in-memory database is tracked in [Memory Backend Architecture](../backends/memory/Architecture.md). The immediate 0.9 implementation slice is tracked in [0.9 In-Memory Database Implementation Plan](../roadmap-implementation/v0.9/In-Memory%20Database%20Implementation%20Plan.md).
