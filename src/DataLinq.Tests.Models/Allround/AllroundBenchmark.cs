...
//public class AllroundBenchmark : IAllroundBenchmark
//{
//    public DbRead<ImmutableProductcategory> Productcategories { get; } = new DbRead<ImmutableProductcategory>(dataSource);";
//}