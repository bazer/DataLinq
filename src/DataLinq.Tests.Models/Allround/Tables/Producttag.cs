...
[Table("producttags")]
public abstract partial class Producttag(RowData rowData, DataSourceAccess dataSource) : Immutable<Producttag>(rowData, dataSource), ITableModel<AllroundBenchmark>
{
    [PrimaryKey]
    [AutoIncrement]
