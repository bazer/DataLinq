...
internal enum BenchmarkScenario
{
    ...
    CompositeKeyReconstructionBaseline,
    ScalarCanonicalKeyPropagation,
    CompositeCanonicalKeyPropagation,
    TypedIdCanonicalKeyPropagation,
    ConverterBackedCanonicalKeyPropagation,
    BinaryCanonicalKeyPropagation,
    SourceBatchSliceCreation,
    SourceRequestConstruction,
    SourceLoaderResultConstruction,
    SourceResultValidation,
    SourceCacheResultPublication,
