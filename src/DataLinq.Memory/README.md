...
The preview intentionally supports only its capability-gated subset. The current profile contains exactly 54 capability tokens:
...
- selectorless `Any` and `Count` over admitted unpaged entity or scalar sequences; and
