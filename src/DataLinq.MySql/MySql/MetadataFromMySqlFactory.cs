    ...
    : MetadataFromSqlFactory(options, DatabaseType.MySQL)
{
    ...
    {
        var information_Schema = new MySqlDatabase<MySQLInformationSchema>(connectionString, "information_schema").Query();
    ...
    protected void ParseIndices(DatabaseDefinition database, MySQLInformationSchema information_Schema)
    {
    ...
    protected void ParseRelations(DatabaseDefinition database, MySQLInformationSchema information_Schema)
    {
