...
operations:
  where and(compare(column(s0.emp_no:Int32) != scalar-binding(p0:Int32?) nulls=c-sharp-nullable-not-equal-includes-null), not-in(column(s0.emp_no:Int32), local-sequence-binding(p1:Int32)))
